...
<body class="bg-gradient-to-br from-slate-50 to-blue-50 min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-black text-slate-900">Region 3 Monitoring Portal</h1>
        ...
        <div class="bg-white rounded-[2rem] p-8 shadow-xl border border-blue-100">
            ...
            <p class="text-sm text-slate-500 mb-8">Access your agency's monitoring dashboard</p>
            ...
            <form action="{{ route('login.post') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="email" name="email" required value="{{ old('email') }}" 
                           class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-slate-700 font-medium transition placeholder-slate-400"
                ...
                <!-- Submit Button -->
                <button type="submit" class="w-full bg-blue-600 text-white font-bold py-3 rounded-xl hover:bg-blue-700 transition duration-300 shadow-lg shadow-blue-200 flex items-center justify-center gap-2">
